...
export class SettingsPage extends PluginSettingTab
{
	...
	static async loadSettings() 
	{
		...
		try
		{
			loadedSettings = await SettingsPage.plugin.loadData() ?? {};
		}
		catch (e)
		{
			console.error("Failed to load plugin settings data, resetting to defaults.", e);
			loadedSettings = {};
		}
		...
		{
			console.error("Failed to apply settings data, using defaults.", e);
			Settings.exportOptions = new ExportPipelineOptions();
		}
